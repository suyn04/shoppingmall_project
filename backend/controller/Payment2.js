...
module.exports = () => {
    ...
    router.post('/join/:id', async (req, res) => {
        ...
        try {
            ...
            let data = [maxOrderId, req.body.email, req.body.pay_to, req.body.order_to, req.body.order_total, req.body.order_tel, req.body.zip, req.body.roadname_address, req.body.building_name, req.body.detail_address, req.body.order_msg, req.body.status];
            ...
            for (let prod of req.body.products) {
                let data2 = [maxOrderId, prod.product_id, prod.order_cnt, prod.product_price];
