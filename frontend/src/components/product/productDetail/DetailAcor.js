    ...
    return (
        <div className={styles.infoTotal}>
            <div className={styles.infoWrap}>
                ...
                <div className={infoOpen[0] ? `${styles.infoContent}` : `${styles.infoContent} ${styles.infoNone}`}>
                    <div>{product.product_ingredient}</div>
                    <div>
                        *제공된 성분은 동일 제품이라도 경우에 따라 변경될 수 있습니다. 최신정보는 제품 포장의 성분을
                        참고하시거나 본사 고객관리지원팀으로 연락 부탁 드립니다.
                    </div>
                    <div>
                        *조 말론 런던의 제품을 구성하는 성분은 변경될 수 있음을 알려드립니다. 제품 뒷면의 성분 목록을
                        확인하시면 가장 최신 성분표를 확인하실 수 있습니다.
                    </div>
                </div>
            </div>
            <div className={styles.infoWrap}>
                ...
                <ul className={infoOpen[1] ? `${styles.infoContent}` : `${styles.infoContent} ${styles.infoNone}`}>
                    <li>
                        1. 화장품 사용 시 또는 사용 후 직사광선에 의하여 사용부위가 붉은 반점, 부어오름 또는 가려움증
                        등의 이상
                    </li>
            ...
            <div className={styles.infoWrap}>
                ...
                <ul className={infoOpen[2] ? `${styles.infoContent}` : `${styles.infoContent} ${styles.infoNone}`}>
                    <li>사용기한 : 제품 별도표기 (출고일 기준 사용기한이 1년 이상 남은 제품을 배송해드립니다)</li>
                    <li>책임판매업자 : 이엘씨에이한국(유)</li>
                    <li>
                        품질 보증 기준 : 이엘씨에이한국(유)를 통해 공식 수입, 판매되는 제품에 한해서, 상품에 이상이 있을
                        경우 공정거래위원회고시 품목별 소비자 분쟁 해결 기준에 의거한 보상 및 제품관련 서비스를 받으실
                        수 있습니다.
                    </li>
                    <li>제조국 : 영국</li>
                </ul>
