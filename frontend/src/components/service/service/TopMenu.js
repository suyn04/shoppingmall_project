    ...
    return (
        <div className="wrapper">
            <div className="swrapper1">
                <div className={activeMenu === 'faq' ? 'active' : ''} onClick={() => handleMenuClick('faq')}>
                ...
                <div className={activeMenu === 'myorder' ? 'active' : ''} onClick={() => handleMenuClick('myorder')}>
                    <Link to={`${urlInfo}myorder`}>나의 오더</Link>
                </div>
                <div className={activeMenu === 'delivery' ? 'active' : ''} onClick={() => handleMenuClick('delivery')}>
                ...
                <div className={activeMenu === 'terms' ? 'active' : ''} onClick={() => handleMenuClick('terms')}>
