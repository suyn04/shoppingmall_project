    ...
    <div className={styles.wrapper}>
      ...
      <div className={styles.imgwrapper}>
        ...
        <div className={styles.iwrapper}>
          ...
          <p className={styles.stitle}>우리의 자선활동 미션
          </p>
          <p>
          우리는 편견과 낙인에 맞서는 정신건강 관련 프로젝트 그리고 영감을 주는 자선단체들을 지원하기 위해 최선을 다하고 있습니다.
          </p>
          <Link to="/chartiymission" className={styles.more}>더 보기</Link>
        </div>
          <div className={styles.iwrapper}>
            ...
            <Link to="/sustainable" className={styles.more}>더 보기</Link>
          </div>
