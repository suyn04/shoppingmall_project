  ...
  return (
    <footer>
      <div className={styles.footerSite}>
        ...
        <div>
          <div
            className={styles.tt}
            onClick={() =>
              isMobile && setIsCustomerServiceOpen(!isCustomerServiceOpen)
            }
          >
            <span>고객 서비스</span>
            {isMobile && (
          ...
          {(isMobile && isCustomerServiceOpen) || !isMobile ? (
            <div>
              <Link
                to="/info/faq"
                className={
                  location.pathname === "/info/faq" ? styles.active : ""
                }
              >
                자주 묻는 질문
              </Link>
              <Link
                to="/info/myprofile"
                className={
                  location.pathname === "/info/myprofile" ? styles.active : ""
                }
              >
                나의 프로필
              </Link>
              <Link
                to="/info/myorder"
                className={
                  location.pathname === "/info/myorder" ? styles.active : ""
                }
              >
                나의 오더
              </Link>
              <Link
                to="/info/delivery"
                className={
                  location.pathname === "/info/delivery" ? styles.active : ""
                }
              >
                배송관련
              </Link>
              <Link
                ...
                className={
                  location.pathname === "/info/excahngerefund"
                    ? styles.active
                    : ""
                }
              >
              ...
              <Link
                ...
                className={
                  location.pathname === "/info/onlineshopping"
                    ? styles.active
                    : ""
                }
              >
        ...
        <div>
          ...
          {(isMobile && isSocialOpen) || !isMobile ? (
            <div>
              <Link to="https://www.instagram.com/jomalonelondon">
                인스타그램
              </Link>
              <Link to="https://www.facebook.com/JoMaloneLondon">페이스북</Link>
              <Link to="https://www.youtube.com/channel/UCWMSJ5L5Zvkr9JfflU4JMUA">
                유튜브
              </Link>
            </div>
          ) : null}
      ...
      <div className={styles.footer}>
        ...
        <div>
          <p>
            이엘씨에이한국(유) 대표: Teng, Hsiao-Hua (Catherine), 서울시 강남구
