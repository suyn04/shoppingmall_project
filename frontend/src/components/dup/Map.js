    ...
    <div className={styles.map}>
      ...
      <main>
        <form onSubmit={(e) => e.preventDefault()}>
          <button type="button" className="place" onClick={handleCurrentLocation}>현재 위치에서 찾기</button>
          <input type="search" placeholder="현재 위치에서 찾기 클릭 또는 도로명으로 검색" value={text} onChange={handleChange}/>
