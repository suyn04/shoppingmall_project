      ...
      <div className={styles.block}>
        ...
        <div className={styles.newsletter}>
          ...
          <p>
            ...
            신제품 선출시 소식과 이벤트, 혜택 등 다양한 최신 정보를 받아보실 수
            있습니다.
          </p>
        </div>
        ...
        <div className={styles.newslettersettings}>
          <div className={styles.checkboxgroup}>
            ...
            <div className={styles.radiobox}>
              <input
                type="radio"
                checked={userInfo.optional_agree === 1}
                onChange={() => optionalAgreeChange(1)}
              />
              <span>수신함</span>
              <input
                type="radio"
                checked={userInfo.optional_agree === 0}
                onChange={() => optionalAgreeChange(0)}
              />
              <span>수신안함</span>
            </div>
          </div>
            ...
            <div className={styles.checkboxgroup}>
              ...
              <div className={styles.radiobox}>
                <input
                  ...
                  onChange={() => genderChange("남자")}
                />
                <span>남자</span>
                <input
                  type="radio"
                  checked={userInfo.gender === "여자"}
                  onChange={() => genderChange("여자")}
                />
                <span>여자</span>
              </div>
            </div>
