      ...
      <div className={styles.wrap}>
        <div>
          ...
          <div className={styles.searchIcon}>
            <img src="/imgs/searchIcon.svg" alt=""/>
            <div id="search">
              <form>
                <button type="button" className={styles.searchClose}><img src="/imgs/close_icon.svg" alt=""/></button>
          ...
          <div className={styles.mapIcon}><Link to="">
            <img src="/imgs/mapIcon.svg" alt=""/>
          </Link></div>
        </div>
        <div className={styles.logo}>
          <Link to=""><img src="/imgs/조말론로고.svg" alt=""/></Link>
        </div>
        <div>
          <div className={styles.myPageIcon}>
            <Link to="">
              <img src="/imgs/myPageIcon.svg" alt=""/>
            </Link>
          </div>
          <div className={styles.basketContainer}>
            <div className={styles.basketIcon}>
              <Link to="">
                <img src="/imgs/basketIcon.svg" alt=""/>
              </Link>
            </div>
          </div>
        </div>
