...
function AdminTemp() {
    ...
    useEffect(() => {
        if (location.pathname.startsWith('/admin/member')) {
            ...
            location.pathname.startsWith('/admin/onetoone') ||
            location.pathname.startsWith('/admin/areviewlist') ||
                ...
                <div className={styles.menu}>
                    {[
                        ...
                        <Link
                            key={index}
                            to={menu.path}
                            className={`${styles.subbar} ${location.pathname === menu.path ? styles.active : ''}`}
                        >
                        ...
                        {topbarLinks.map((link, index) => (
                            <Link
                                ...
                                className={`${styles.topbarLink} ${
                                    location.pathname === location.pathname.startsWith(link.path) ? styles.active : ''
                                }`}
                            >
