...
const AProductRegisterOpt = () => {
    ...
    const productAxiosGet = () => {
        ...
        axios
            .get(`http://localhost:5001/admin/product/register/option/${product_id}`)
            .then((res) => {
    ...
    const submitGo = (me) => {
        ...
        axios
            .post(`http://localhost:5001/admin/product/register/option/${product_id}`, frmData, {
                headers: {
    ...
    const delGo = (product_opt_id) => {
        ...
        axios
            .delete(`http://localhost:5001/admin/product/register/option/${product_opt_id}`, {
    ...
    function fileGo(file) {
        if (file) {
            return <img src={`http://localhost:5001/imgs/product/${file}`} width="100px" />;
        }
        return null;
    }
