...
(22,'라임 바질 앤 만다린 디퓨저','Lime Basil & Mandarin Diffuser',NULL,3,'citrus',NULL,1,'조 말론 런던의 모던한 클래식 제품으로 공간을 채워보세요. 약 3-4달 동안 지속적으로 향기가 유지되며, 최적의 사용을 위해 10개의 리드를 동시에 사용해 주세요','에톡시디글라이콜,향료(리모넨 등) 자가검사번호: FB20-12-2207 ',NULL,NULL,NULL,'2024-12-06 13:47:35'),
...
(20,'과이액목','매혹적이고 스모키한 나무 향이 스며들어 관능적인 분위기를 자아냅니다','note_guaiacwood.jpg','note_guaiacwood.jpg'),
(21,'암브레트 시드','정교한 아우라로 탑 노트를 감싸는 질감의 특징입니다.','note_ambretteseeds.jpg','note_ambretteseeds.jpg'),
...
-- Dump completed on 2024-12-12 15:35:45
